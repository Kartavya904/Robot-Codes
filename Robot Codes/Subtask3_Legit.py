    ...
    for x in range (0,4) :
        while True :
            ...
            while( color == None) :
                ...
                break
    print(scanned_Barcode)
    if Barcode1 == scanned_Barcode : 
        equalYesNo = 1
    elif Barcode2== scanned_Barcode: 
        equalYesNo = 2
    elif Barcode3 == scanned_Barcode : 
        equalYesNo = 3
    elif Barcode4 == scanned_Barcode : 
        equalYesNo = 1
    return equalYesNo
...
def subtask3():
    ...
    barcode = "Box Type: " + str(barcode)
    ev3.screen.draw_text(25, 50, str(barcode))
